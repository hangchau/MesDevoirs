...
// ============================================================
// Index des clés :
//   "sec1_0" = Secondaire 1 – Français
//   "sec1_1" = Secondaire 1 – Mathématique
//   "sec1_2" = Secondaire 1 – Science et technologie
//   "sec1_3" = Secondaire 1 – Géographie & histoire
//   "sec1_4" = Secondaire 1 – Anglais
//   "sec1_5" = Secondaire 1 – Arts
//   "sec1_6" = Secondaire 1 – Éducation physique
//   "sec1_7" = Secondaire 1 – Culture et citoyenneté (CCQ)
//   "pri5_0" = 5e Année – Français
//   "pri5_1" = 5e Année – Mathématique
//   "pri5_2" = 5e Année – Science et technologie
//   "pri5_3" = 5e Année – Géographie & histoire
//   "pri5_4" = 5e Année – Anglais
//   "pri5_5" = 5e Année – Arts
//   "pri5_6" = 5e Année – Éducation physique
//   "pri5_7" = 5e Année – Culture et citoyenneté (CCQ)
// ------------------------------------------------------------
// Format d'une question :
// {
//   subtopic : "Grammaire",          // sous-sujet exact du DATA
//   type     : "mcq" | "open",
//   question : "...",
//   choices  : ["A","B","C","D"],    // null si type=open
//   answer   : "...",                // texte exact du bon choix (mcq) ou réponse modèle (open)
//   solution : "..."                 // explication pédagogique
// }
// ============================================================
...
var QUESTION_BANK = {
  ...
  "sec1_0": [
    ...
    // --- Analyse de texte ---
    {subtopic:"Analyse de texte",type:"mcq",
  ...
  "sec1_1": [
    // --- Arithmétique ---
    {subtopic:"Arithmétique",type:"mcq",
    ...
    // --- Fractions & décimaux ---
    {subtopic:"Fractions & décimaux",type:"mcq",
    ...
    // --- Probabilités ---
    {subtopic:"Probabilités",type:"mcq",
    ...
    // --- Statistiques ---
    {subtopic:"Statistiques",type:"mcq",
  ...
  "sec1_2": [
    ...
    {subtopic:"Méthode scientifique",type:"mcq",
    ...
    {subtopic:"Méthode scientifique",type:"open",
    ...
    // --- Matière & énergie ---
    {subtopic:"Matière & énergie",type:"mcq",
    ...
    // --- Environnement ---
    {subtopic:"Environnement",type:"open",
    ...
    // --- Systèmes techniques ---
    {subtopic:"Systèmes techniques",type:"mcq",
    ...
    // --- Projets techno ---
    {subtopic:"Projets techno",type:"open",
  ...
  "sec1_3": [
    // --- Sociétés du monde ---
    {subtopic:"Sociétés du monde",type:"mcq",
    ...
    {subtopic:"Sociétés du monde",type:"open",
    ...
    {subtopic:"Grandes civilisations",type:"mcq",
    ...
    // --- Cartes & atlas ---
    {subtopic:"Cartes & atlas",type:"open",
    ...
    {subtopic:"Repères chronologiques",type:"mcq",
    ...
    // --- Droits & démocratie ---
    {subtopic:"Droits & démocratie",type:"mcq",
  ...
  "sec1_4": [
    // --- Speaking & listening ---
    {subtopic:"Speaking & listening",type:"mcq",
    ...
    {subtopic:"Reading comprehension",type:"open",
    ...
    // --- Media texts ---
    {subtopic:"Media texts",type:"open",
  ...
  "sec1_5": [
    // --- Arts plastiques ---
    {subtopic:"Arts plastiques",type:"mcq",
     ...
     solution:"En peinture (synthèse soustractive), les couleurs primaires sont le rouge, le jaune et le bleu. En mélangent ces couleurs, on obtient les couleurs secondaires."},
    {subtopic:"Arts plastiques",type:"open",
    ...
    // --- Art dramatique ---
    {subtopic:"Art dramatique",type:"open",
  ...
  "sec1_6": [
    // --- Sports collectifs ---
    {subtopic:"Sports collectifs",type:"mcq",
    ...
    {subtopic:"Sports collectifs",type:"open",
    ...
    // --- Condition physique ---
    {subtopic:"Condition physique",type:"mcq",
    ...
    // --- Hygiène & santé ---
    {subtopic:"Hygiène & santé",type:"mcq",
  ...
  "sec1_7": [
    // --- Identité québécoise ---
    {subtopic:"Identité québécoise",type:"mcq",
    ...
    {subtopic:"Identité québécoise",type:"open",
     question:"Nomme deux éléments qui caractérisent l'identité culturelle québécoise et explique leur importance.",
     choices:null,
     answer:"Ex. : 1) La langue française – véhicule de la culture, de la littérature et des arts québécois. 2) L'histoire de la Nouvelle-France – fondement de la mémoire collective et des institutions. (Autres réponses valides : la fête nationale, la gastronomie, la musique traditionnelle...)",
    ...
    {subtopic:"Valeurs démocratiques",type:"mcq",
    ...
    {subtopic:"Diversité culturelle",type:"mcq",
    ...
    // --- Enjeux sociaux ---
    {subtopic:"Enjeux sociaux",type:"open",
     ...
     solution:"L'intimidation peut être physique, verbale, sociale ou cybernétique. Ses impacts sur la santé mentale sont sérieux et documentés. Des réponses variées sont acceptables."},
    // --- Dialogue éthique ---
    {subtopic:"Dialogue éthique",type:"mcq",
  ...
  "pri5_0": [
    ...
    // --- Compréhension ---
    {subtopic:"Compréhension",type:"mcq",
  ...
  "pri5_1": [
    // --- Nombres naturels ---
    {subtopic:"Nombres naturels",type:"mcq",
    ...
    {subtopic:"Nombres naturels",type:"open",
     ...
     solution:"On lit les nombres en groupes : deux cent mille = 200 000 ; trois cent quarante-huit = 348. La valeur positionnelle dépend de la colonne (unités, dizaines, centaines, milliers...)."},
    // --- Opérations ---
    {subtopic:"Opérations (+−×÷)",type:"mcq",
     question:"Calcule : 48 ÷ 6 = ?",
     choices:["7","8","9","6"],
     answer:"8",
     solution:"La division est l'opération inverse de la multiplication. 6 × 8 = 48, donc 48 ÷ 6 = 8. On peut aussi vérifier : 8 × 6 = 48."},
    // --- Fractions & décimaux ---
    {subtopic:"Fractions & décimaux",type:"mcq",
    ...
    {subtopic:"Géométrie",type:"mcq",
     ...
     choices:["4","5","6","8"],
     answer:"6",
     solution:"Un hexagone a 6 côtés et 6 angles. Le préfixe 'hexa' signifie six en grec. Ex. : les alvéoles des ruches d'abeilles sont de forme hexagonale."},
    // --- Mesures ---
    {subtopic:"Mesures",type:"open",
     ...
     solution:"Pour convertir des mètres en centimètres, on multiplie par 100. La démarche montre la compréhension du système de mesure."},
    // --- Probabilités ---
    {subtopic:"Probabilités",type:"mcq",
    ...
    {subtopic:"Statistiques",type:"mcq",
     ...
     choices:["4","6","8","10"],
     answer:"6",
     solution:"Le mode est la valeur qui apparaît le plus souvent. Ici, 6 apparaît deux fois, tandis que les autres valeurs n'apparaissent qu'une fois. Le mode est donc 6."}
  ],

  "pri5_2": [
    // --- Corps humain ---
    {subtopic:"Corps humain",type:"mcq",
     question:"Quel organe pompe le sang dans tout le corps ?",
     choices:["Les poumons","Le foie","Le cœur","Les reins"],
     answer:"Le cœur",
     solution:"Le cœur est un muscle creux qui bat en moyenne 70 fois par minute. Il propulse le sang dans les artères et le reçoit par les veines, assurant la circulation sanguine."},
    {subtopic:"Corps humain",type:"open",
    ...
    {subtopic:"Écosystèmes",type:"mcq",
     ...
     solution:"Une chaîne alimentaire représente le transfert d'énergie et de matière d'un organisme à l'autre. Ex. : herbe → lapin → renard. Elle commence toujours par un producteur (plante)."},
    // --- Matière & énergie ---
    {subtopic:"Matière & énergie",type:"mcq",
     ...
     solution:"La masse volumique est la masse d'un matériau par unité de volume. Le fer est beaucoup plus dense que le bois. C'est une propriété caractéristique de la matière."},
    // --- Forces simples ---
    {subtopic:"Forces simples",type:"open",
     ...
     solution:"La friction est une force de résistance qui s'oppose au mouvement entre deux surfaces. Sans elle, il serait impossible de marcher, d'attraper des objets ou de freiner."},
    // --- Expériences ---
    {subtopic:"Expériences",type:"mcq",
     ...
     solution:"Le groupe témoin ne reçoit pas le traitement expérimental. Il sert de point de comparaison pour savoir si c'est bien la variable testée qui cause un changement observé."}
  ],

  "pri5_3": [
    // --- Sociétés autochtones ---
    {subtopic:"Sociétés autochtones",type:"mcq",
     ...
     answer:"Les Iroquois",
     solution:"Les Iroquois (Haudenosaunee) occupaient la vallée du Saint-Laurent et le nord de l'État de New York. Jacques Cartier les a rencontrés lors de ses voyages en 1534-1542."},
    {subtopic:"Sociétés autochtones",type:"open",
     question:"Décris deux caractéristiques de la société des Algonquins (mode de vie, économie) avant l'arrivée des Européens.",
     choices:null,
     answer:"Les Algonquins étaient semi-nomades : ils se déplaçaient selon les saisons pour chasser, pêcher et cueillir. Leur organisation sociale était basée sur des bandes familiales. (Autres éléments valides : usage du canot, tipi, troc, traditions orales.)",
     solution:"Les sociétés autochtones avaient des modes de vie adaptés à leur environnement. Les Algonquins de la forêt boréale avaient un mode de vie différent des Iroquois sédentaires agriculteurs."},
    // --- Nouvelle-France ---
    {subtopic:"Nouvelle-France",type:"mcq",
    ...
    // --- Régime britannique ---
    {subtopic:"Régime britannique",type:"mcq",
     ...
     solution:"À la suite de la guerre de Sept Ans et de la défaite française sur les plaines d'Abraham (1759), le Traité de Paris (1763) cède officiellement le Canada à la Grande-Bretagne."},
    // --- Cartes du Québec ---
    {subtopic:"Cartes du Québec",type:"open",
     question:"Nomme les deux principales régions administratives du Québec (selon ce que tu connais) et indique une caractéristique géographique de chacune.",
     choices:null,
     answer:"Exemples valides : Montréal (île, fleuve Saint-Laurent, métropole) ; Abitibi-Témiscamingue (forêt boréale, mines, lacs) ; Gaspésie (péninsule, monts Chic-Chocs, mer) etc.",
     solution:"Le Québec compte 17 régions administratives. La réponse varie selon les régions choisies. Les caractéristiques géographiques incluent le relief, l'hydrographie et le climat."},
    // --- Repères historiques ---
    {subtopic:"Repères historiques",type:"mcq",
     question:"En quelle année la Confédération canadienne a-t-elle été proclamée ?",
     choices:["1534","1760","1867","1980"],
     answer:"1867",
     solution:"Le 1er juillet 1867, l'Acte de l'Amérique du Nord britannique crée la Confédération canadienne en unissant le Canada-Uni, la Nouvelle-Écosse et le Nouveau-Brunswick."}
  ],

  "pri5_4": [
    // --- Listening & speaking ---
    {subtopic:"Listening & speaking",type:"mcq",
     ...
     solution:"'Nice to meet you' is the standard greeting when meeting someone for the first time. It is a polite expression used in English-speaking cultures."},
    // --- Simple reading ---
    {subtopic:"Simple reading",type:"mcq",
     question:"Read: 'Tom has a red bike. He rides it to school every day.' What colour is Tom's bike?",
     choices:["Blue","Green","Red","Yellow"],
     answer:"Red",
     solution:"The text says 'Tom has a red bike.' The answer is directly stated in the first sentence. This is a literal reading comprehension question."},
    // --- Vocabulary ---
    {subtopic:"Vocabulary",type:"mcq",
     question:"What is the opposite (antonym) of 'hot'?",
     choices:["Warm","Cold","Big","Fast"],
     answer:"Cold",
     solution:"Antonyms are words with opposite meanings. Hot ↔ Cold, big ↔ small, fast ↔ slow. Learning antonyms helps build vocabulary."},
    // --- Short writing ---
    {subtopic:"Short writing",type:"open",
     ...
     solution:"Simple present tense is used for facts and habits. Subject + verb (+ s for he/she/it). Check for subject-verb agreement and capital letters."},
    // --- Basic grammar ---
    {subtopic:"Basic grammar",type:"mcq",
     ...
     solution:"In the simple present tense, we use 'doesn't' (does not) for he/she/it in negative sentences. The main verb stays in its base form: 'like' (not 'likes')."},
    // --- Songs & poems ---
    {subtopic:"Songs & poems",type:"open",
     ...
     solution:"Songs and poems use figurative language (similes, metaphors). A simile compares using 'like' or 'as'. Here, the star is compared to a diamond."}
  ],
  ...
  "pri5_5": [
    ...
    {subtopic:"Arts plastiques",type:"mcq",
     ...
     answer:"Orange",
     solution:"En peinture (couleurs primaires : rouge, jaune, bleu), le mélange rouge + jaune donne l'orange. C'est une couleur secondaire."},
    {subtopic:"Arts plastiques",type:"open",
     question:"Décris ce qu'est une 'composition' en arts plastiques. Quels éléments peut-on organiser dans une composition ?",
     choices:null,
     answer:"Une composition est l'organisation des éléments visuels dans l'espace de la feuille ou de la toile. On y place des formes, des couleurs, des lignes et des textures de façon équilibrée ou dynamique pour créer un effet voulu.",
    ...
    // --- Dessin & peinture ---
    {subtopic:"Dessin & peinture",type:"mcq",
     ...
     solution:"Le pointillisme (développé par Seurat et Signac) utilise des petits points de couleurs pures. Vus à distance, les points se mélangent optiquement pour créer des teintes."},
    // --- Musique ---
    {subtopic:"Musique",type:"mcq",
     ...
     solution:"La hauteur du son indique s'il est grave (basse fréquence) ou aigu (haute fréquence). C'est différent du volume (fort/doux) et du timbre (couleur du son selon l'instrument)."},
    // --- Art numérique ---
    {subtopic:"Art numérique",type:"open",
     question:"Nomme deux différences entre l'art numérique et la peinture traditionnelle.",
     choices:null,
     answer:"1) L'art numérique se crée sur ordinateur/tablette, la peinture avec des pinceaux et de la toile. 2) L'art numérique peut être facilement modifié (annuler, copier-coller), contrairement à la peinture.",
     solution:"L'art numérique utilise des outils technologiques mais applique les mêmes principes visuels (couleur, composition, forme). Plusieurs réponses sont acceptables."}
  ],

  "pri5_6": [
    // --- Sports & jeux ---
    {subtopic:"Sports & jeux",type:"mcq",
     question:"Combien de joueurs y a-t-il dans une équipe de soccer (football) sur le terrain ?",
     choices:["9","10","11","12"],
     answer:"11",
     solution:"Une équipe de soccer est composée de 11 joueurs sur le terrain : 1 gardien de but et 10 joueurs de champ (défenseurs, milieux de terrain et attaquants)."},
    {subtopic:"Sports & jeux",type:"open",
     question:"Explique les règles de base du jeu de balle-molle (baseball simplifié) pour quelqu'un qui ne l'a jamais joué.",
     choices:null,
     answer:"Un frappeur essaie de frapper la balle lancée par le lanceur. S'il frappe, il court vers les buts. L'équipe en défense doit attraper la balle ou la lancer sur un but avant le coureur pour le retirer.",
     solution:"La balle-molle (softball) est une variante du baseball. L'explication doit inclure les rôles (frappeur, lanceur, défense) et l'objectif (marquer des points en complétant les buts)."},
    // --- Habiletés motrices ---
    {subtopic:"Habiletés motrices",type:"mcq",
     ...
     answer:"Le lancer",
     solution:"La passe (au basketball) est une forme de lancer. Les habiletés motrices de base comprennent la locomotion (courir, sauter) et la manipulation (lancer, attraper, frapper)."},
    // --- Saine alimentation ---
    {subtopic:"Saine alimentation",type:"mcq",
     ...
     answer:"De l'eau",
     solution:"L'eau est la meilleure boisson pour s'hydrater. Elle n'apporte pas de sucre ajouté ni de caféine. Les boissons sucrées ou énergisantes ne sont pas recommandées pour les enfants."},
    // --- Condition physique ---
    {subtopic:"Condition physique",type:"open",
     question:"Nomme 3 activités physiques adaptées à un enfant de 11 ans et explique le bienfait principal de chacune.",
     choices:null,
     answer:"Ex. : 1) Natation → endurance cardiovasculaire et musculation sans impact. 2) Vélo → développement des jambes et cardio. 3) Yoga → flexibilité et gestion du stress. (Toute activité valide acceptée.)",
  ...
  "pri5_7": [
    ...
    {subtopic:"Traditions du Québec",type:"mcq",
     ...
     solution:"Le 24 juin est la fête nationale du Québec, la Saint-Jean-Baptiste. Elle est célébrée par des feux de joie, des festivals et des rassemblements en l'honneur de la culture québécoise."},
    {subtopic:"Traditions du Québec",type:"open",
     question:"Décris deux traditions québécoises que tu connais et explique leur importance pour la culture québécoise.",
     choices:null,
     answer:"Ex. : 1) La cabane à sucre au printemps – tradition rurale liée à la récolte du sirop d'érable, produit emblématique du Québec. 2) Le carnaval de Québec en hiver – célèbre la culture hivernale unique du Québec.",
     solution:"Les traditions reflètent l'histoire, les valeurs et l'environnement d'une culture. Pour le Québec, beaucoup de traditions sont liées aux saisons, à la nature et à l'histoire française."},
    // --- Valeurs partagées ---
    {subtopic:"Valeurs partagées",type:"mcq",
     ...
     solution:"La Charte des droits et libertés de la personne du Québec (1975) garantit l'égalité de tous sans discrimination basée sur la race, le sexe, la religion, etc."},
    // --- Respect des différences ---
    {subtopic:"Respect des différences",type:"mcq",
     ...
     solution:"La discrimination consiste à traiter quelqu'un de manière injuste ou défavorable à cause de caractéristiques comme sa race, sa religion, son sexe ou son âge. Elle est interdite par les chartes des droits."},
    // --- Règles de vie ---
    {subtopic:"Règles de vie",type:"open",
     ...
     solution:"Les règles de vie collective servent à protéger les droits de chacun, à maintenir un environnement propice aux apprentissages et à développer le sens des responsabilités."},
    // --- Dialogue ---
    {subtopic:"Dialogue",type:"mcq",
     ...
     solution:"L'écoute active implique de regarder la personne, de ne pas l'interrompre, de reformuler ce qu'elle dit et de poser des questions pour mieux comprendre. C'est la base d'un dialogue respectueux."}
  ]
